...
namespace ConsoleProgressBar.Extensions {
  ...
  public static class TimeSpanExtensions {
    ...
    /// <param name="ts"></param>
    /// <returns></returns>
    public static string ToStringAsSumarizedRemainingText(this TimeSpan? ts) => ts.HasValue ? ToStringAsSumarizedRemainingText(ts.Value) : "unknown";
    ...
    /// <returns></returns>
    public static string ToStringWithAllHours(this TimeSpan? ts, bool includeMilliseconds = true) => ts.HasValue ? ToStringWithAllHours(ts.Value, includeMilliseconds) : "unknown";
    ...
    /// <param name="includeMilliseconds"></param>
    /// <returns></returns>
    public static string ToStringWithAllHours(this TimeSpan ts, bool includeMilliseconds = true) => includeMilliseconds ? $"{ts.TotalHours:F0}{ts:\\:mm\\:ss\\.fff}" : $"{ts.TotalHours:F0}{ts:\\:mm\\:ss}";
  }
}
