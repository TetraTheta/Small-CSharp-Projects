...
namespace ConsoleProgressBar {
  public partial class Layout {
    ...
    public class LayoutBody {
      ...
      /// <returns></returns>
      public LayoutBody SetValue(char value) => SetValue(pb => value);
      ...
      /// <returns></returns>
      public LayoutBody SetForegroundColor(ConsoleColor foregroundColor) => SetForegroundColor(pb => foregroundColor);
      ...
      /// <returns></returns>
      public LayoutBody SetBackgroundColor(ConsoleColor backgroundColor) => SetBackgroundColor(pb => backgroundColor);
