  ...
  public partial class Layout {
    ...
    public class LayoutMarquee {
      ...
      */
      ...
      /// <returns></returns>
      public LayoutMarquee SetForegroundColor(ConsoleColor foregroundColor) => SetForegroundColor(pb => foregroundColor);
      ...
      /// <returns></returns>
      public LayoutMarquee SetBackgroundColor(ConsoleColor backgroundColor) => SetBackgroundColor(pb => backgroundColor);
      ...
      /// <returns></returns>
      public LayoutMarquee SetVisible(bool visible) => SetVisible(pb => visible);
      ...
      public LayoutMarquee() {
        OverPending.SetValue(pb => pb.HasProgress ? '+' : '■').SetForegroundColor(pb => pb.HasProgress ? ConsoleColor.Yellow : ConsoleColor.Green);
        OverProgress.SetValue('■').SetForegroundColor(ConsoleColor.Yellow);
      }
    }
  }
}
