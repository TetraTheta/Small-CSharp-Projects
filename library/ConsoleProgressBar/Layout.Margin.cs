  ...
  public partial class Layout {
    ...
    public class LayoutMargin {
      ...
      */
      ...
      /// <returns></returns>
      public LayoutMargin SetValue(string value) => SetValue(pb => value);
      ...
      /// <returns></returns>
      public LayoutMargin SetForegroundColor(ConsoleColor foregroundColor) => SetForegroundColor(pb => foregroundColor);
      ...
      /// <returns></returns>
      public LayoutMargin SetBackgroundColor(ConsoleColor backgroundColor) => SetBackgroundColor(pb => backgroundColor);
      ...
      /// <returns></returns>
      public LayoutMargin SetVisible(bool visible) => SetVisible(pb => visible);
      ...
      /// <returns></returns>
      public int GetLength(ProgressBar progressBar) => (Start.GetValue(progressBar)?.Length ?? 0) + (End.GetValue(progressBar)?.Length ?? 0);
