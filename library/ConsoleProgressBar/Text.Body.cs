...
namespace ConsoleProgressBar {
  public partial class Text {
    ...
    public class TextBody {
      ...
      /// <returns></returns>
      public TextBody SetVisible(bool show) => SetVisible(pb => show);
      ...
      /// <returns></returns>
      public TextBody SetValue(string value) => SetValue(pb => value);
      ...
      /// <returns></returns>
      public TextBody SetForegroundColor(ConsoleColor foregroundColor) => SetForegroundColor(pb => foregroundColor);
      ...
      /// <returns></returns>
      public TextBody SetBackgroundColor(ConsoleColor backgroundColor) => SetBackgroundColor(pb => backgroundColor);
      ...
      /// </summary>
      public TextBody() {
        Processing.SetValue(pb => pb.HasProgress ? $"{pb.Value} of {pb.Maximum} in {pb.TimeProcessing.ToStringWithAllHours()}, remaining: {pb.TimeRemaining.ToStringAsSumarizedRemainingText()}" : $"Processing... ({pb.Value} in {pb.TimeProcessing.ToStringWithAllHours()})").SetForegroundColor(ConsoleColor.Cyan);

        Paused.SetValue(pb => pb.HasProgress ? $"Paused... Running time: {pb.TimeProcessing.ToStringWithAllHours()}" : $"{pb.Value} of {pb.Maximum} in {pb.TimeProcessing.ToStringWithAllHours()} (paused)").SetForegroundColor(ConsoleColor.DarkCyan);
