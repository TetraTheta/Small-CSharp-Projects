...
namespace ConvertWebP.Libraries {
  ...
  public class Dialogs {
    ...
    public static void ShowError(string content, bool doExit = true) {
      SystemSounds.Exclamation.Play();
      Messenger.MessageBox(content, Resources.ErrTitle, Base64Icons.MsgIcon.Error, System.Windows.Forms.MessageBoxButtons.OK);
      if (doExit) Environment.Exit(1);
    }
    ...
    public static void ShowInfo(string content, string title, bool doExit = true, int exitCode = 1) {
      ...
      SystemSounds.Exclamation.Play();
      Messenger.MessageBox(content, title, Base64Icons.MsgIcon.Info, System.Windows.Forms.MessageBoxButtons.OK);
